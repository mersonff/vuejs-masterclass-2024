...
declare global {
  ...
  const acceptH: (typeof import('pinia'))['acceptH']
  ...
  const use: (typeof import('./src/composables/collabs'))['use']
  ...
  const userP: (typeof import('./src/stores/loaders/projects'))['userP']
