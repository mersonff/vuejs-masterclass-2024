      ...
      <CardContent>
        ...
        <form class="grid gap-4" @submit.prevent="signup">
          ...
          <div class="flex flex-col sm:flex-row justify-between gap-4">
            <div class="grid gap-2">
              <Label id="firstName" class="text-left">First Name</Label>
              <Input
                id="firstName"
                type="text"
                placeholder="John"
            ...
            <div class="grid gap-2">
              <Label id="lastName" class="text-left">Last Name</Label>
              <Input
                id="lastName"
                type="text"
                placeholder="Doe"
          ...
          <div class="grid gap-2">
            <Label id="confirmPassword" class="text-left">Confirm Password</Label>
            <Input
              id="confirmPassword"
              type="password"
              placeholder="*****"
